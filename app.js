document.addEventListener("DOMContentLoaded", () => {
  ...
  const lTetromino = [
    ...
    [1, width + 1, width + 1, width * 2 + 1, width * 2],
  ...
  //randomly select a piece and its rotation
  let random = Math.floor(Math.random() * theTretrominoes.length);
  let current = theTretrominoes[random][currentRotation];
  ...
  //add functinality to the button
